    ...
    <>
      ...
      <Section>
        ...
        <p className="pb-4">
          ...
          is available{' '}
          <a
            href="https://github.com/spencerkingman/professional-page/blob/main/src/routes/KeyboardSmashDetector.tsx/DemoSection.tsx"
          ...
          , and the logic is{' '}
          <a
            href="https://github.com/spencerkingman/professional-page/blob/main/src/utils/keyboard-smash-detector-utils.ts"
            className="hover:text-white active:text-gray-300 underline"
            target="_blank"
          >
            here
